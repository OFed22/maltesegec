...
# artificial data part - ASR configuration
TOKEN_ERR_PROB="0.15"
TOKEN_ERR_DISTRIBUTION="0.7_0.1_0.1_0.1_0"  # Same as basic
...
ASR_MAPPING_FILE="/app/malteseGEC/data/monolingual/common_voice/processed/asr_mappings.tsv"
ASR_PROB="0.04"
