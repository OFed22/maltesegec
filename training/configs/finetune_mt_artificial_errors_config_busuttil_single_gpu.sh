...
# Authentic data paths - Busuttil transcription errors only
INPUT_SENTENCE_FILE="/app/malteseGEC/data/authentic/splits/train/busuttil_src.txt"
TARGET_SENTENCE_FILE="/app/malteseGEC/data/authentic/splits/train/busuttil_trg.txt"
...
NO_EDIT_DATA_DIR=${DATA_DIR}/$PROBLEM-$LANG-busuttil-finetune-tep$TOKEN_ERR_PROB-ted$TOKEN_ERR_DISTRIBUTION-cep$CHAR_ERROR_PROB-ced$CHAR_ERR_DISTRIBUTION-aas${ADDITIONAL_ARTIFICIAL_SENTENCES}-dr${DATA_RATIO}
...
TRAIN_DIR_FINETUNED=${TRAIN_DIR}/$PROBLEM-$LANG-busuttil-finetune-tep$TOKEN_ERR_PROB-ted$TOKEN_ERR_DISTRIBUTION-cep$CHAR_ERROR_PROB-ced$CHAR_ERR_DISTRIBUTION/$MODEL-$MODEL_TYPE-iwdr${INPUT_WORD_DROPOUT_RATE}-twdr${TARGET_WORD_DROPOUT_RATE}-ew${EDIT_WEIGHT}-ws${WARMUP_STEPS}-lrc${LEARNING_RATE_CONSTANT}-aas${ADDITIONAL_ARTIFICIAL_SENTENCES}-dr${DATA_RATIO}
